...
<body>
	<table cellpadding="3" cellspacing="1" width="100%" border="0" align="center">
		...
		<tr>
			<td height=25 colspan="8" class="td_title">可申借资产列表</td>
		</tr>
		
		<tr>
			<td height=23 width="19%" align="center">资产编号</td>
		    <td height=23 width="19%" align="center">资产名称</td>
		    <td height=23 width="19%" align="center">使用类型</td>
			<td height=23 width="19%" align="center">状态</td>
		    <td height=23 width="19%" align="center">折旧率</td>
		...
		<tr>
		    ...
		    <td height=23 align="center">申请添加</td>
		    </logic:equal>
		    
			
			<td height=23 align="center">${asset.dep }</td>
			<td height=23 align="center"><a href="/asset_mms/action/borrow.do?method=tolendform&m=${asset.assetId }">申借</a></td>
		</tr>
		</c:forEach>
	</table>
	<br/>
