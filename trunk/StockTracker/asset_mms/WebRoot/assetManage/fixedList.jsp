...
<body>
	<table cellpadding="3" cellspacing="1" width="100%" border="0" align="center">
		...
		<tr>
			<td height=25 colspan="8" class="td_title">修缮资产列表</td>
		</tr>
		
		<tr>
			<td height=23 width="12%" align="center">资产编号</td>
		    <td height=23 width="12%" align="center">资产名称</td>
		    <td height=23 width="12%" align="center">审批时间</td>
			<td height=23 width="12%" align="center">修理价格</td>
			<td height=23 width="12%" align="center">修配厂商</td>
			<td height=23 width="18%" align="center">故障原因</td>
			<td height=23 width="12%" align="center">审批人</td>
		...
		<tr>
			...
			<td height=23 align="center"><a href="/asset_mms/action/fix.do?method=fixedback&m=${fix.asset.assetId }&n=${fix.fixId }">归还资产</a></td>
		</tr>
		</c:forEach>
