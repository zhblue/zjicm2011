...
<body>
	<table cellpadding="3" cellspacing="1" width="100%" border="0" align="center">
		...
		<tr>
			<td height=25 colspan="8" class="td_title">自选股添加列表</td>
		</tr>
		
		<tr>
			<td height=23 width="19%" align="center">股票名称</td>
		...
		<tr>
			...
			<td height=23 align="center"><a href="/asset_mms/action/asset.do?method=fixListById&m=${asset.assetId }">报修</a></td>
		</tr>
		</c:forEach>
	</table>
	<br/>
