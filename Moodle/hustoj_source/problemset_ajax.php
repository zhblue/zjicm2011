...
while ($row=mysql_fetch_object($result)){
	...
	echo "<td>";
	echo '<input type="radio" name="problem_id" id="problem_'.$row->problem_id.'" value="'.$row->problem_id.'"></input>';
	echo "</td>";
	echo "<td align='center'>".$row->problem_id."</td>";
	echo "<td align='left'><label for=\"problem_{$row->problem_id}\">".$row->title."</label></td>";
