...
// Settings
	...
	$extension_whitelist = array("doc", "txt", "jpg", "gif", "png","swf");	// Allowed file extensions
...
// Process the file
	...
	*/
	...
	mysql_query("insert into video(vname,vtype,vurl,vlevel,vdate) values ('".$_POST['name']."','".$_POST['type']."','http://localhost/manage/swfupload/file/".$file_name."','".$_POST['level']."','".date("y-m-d H:i:s")."')");
	}
